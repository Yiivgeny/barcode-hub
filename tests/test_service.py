...
def test_put_decode_returns_minimal_contract_and_server_header():
    ...
    response = client.put("/decode?types=EAN13", content=b"fake", headers={"content-type": "image/png"})
...
def test_url_prefix_matching_is_url_parser_based():
    ...
    assert match_url_prefix("https://example.com/assets/{tenant}/", "https://example.com/assets/acme/a.png")
    assert not match_url_prefix("https://example.com/assets/{tenant}/", "https://example.com/other/acme/a.png")
